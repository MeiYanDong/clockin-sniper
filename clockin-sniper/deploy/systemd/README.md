...
- `clockin-executor`, `clockin-reconciler`, and `clockin-exit` validate the exact `root:clockin 0440` paid marker before reading any paid RPC credential;
...
- `clockin-executor` additionally validates the exact `root:clockin 0440` production-arm marker before reading any signer credential;
